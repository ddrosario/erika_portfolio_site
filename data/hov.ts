...
export const data = [
  {
    title: 'Internal Interviews',
    body: 'To determine what could be improved on the site, I conducted internal interviews with team members.',
    images: [
      {
        webp: '/assets/projects/hov/internal-interviews.webp',
        jpg: '/assets/projects/hov/internal-interviews.jpg',
  ...
  {
    title: 'UI Kit',
    body: 'To assist the team in visualizing what themes I was going for and what elements I have used on the pages I have developed thus far, I created a User Interface Kit.',
    images: [
      {
        webp: '/assets/projects/hov/ui-kit.webp',
        jpg: '/assets/projects/hov/ui-kit.jpg',
